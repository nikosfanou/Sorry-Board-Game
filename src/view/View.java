...
public class View extends JFrame{
    ...
    /**
     * All the components of the game will be added 
     * here in order to be shown.
     */
    ...
    public void createPackOfCards() {
    	...
    	//packOfCards.setIcon(new ImageIcon(new ImageIcon(tableBackground.getClass().getResource("images/images/cards/backCard.png")).getImage().getScaledInstance(36, 36, Image.SCALE_SMOOTH)));
   ...
   infoBox.setBounds(750, 350, 185, 100);
    ...
    /**
     * Creates the squares of the board. Every square will have
     * the color/image corresponding to its type.
     * @pre Parameter is not null.
...
if(i==49 || i==58) {
 ...
 //start squares
     ...
     * @param info The message we want to be shown at the info
     * box.
     */
    ...
    /**
     * Initializes all the components of the game by 
     * calling the right/above methods and adds them
     * to the basic_panel.
     * @pre
     * @post Initializes all the components and adds them to the 
     * basic_panel.
     */
     ...
     * @pre
     * @post Adds the panel to the jframe in order to
     * show the components of the game.
     */
