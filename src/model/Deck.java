...
public class Deck {
	...
	/**
	 * The latest card played. If the latest card played was card with number 2 then the turn doesn't change.
	 */
	...
	/**
	 * Initializes the board with the squares, the deck with the cards, and the two players with their two pawns each.
	 * @pre 
	 * @post Initializes the board with the squares, the deck with the cards, and the two players with their two pawns each.
	 */
	...
	/**
	 * Chooses a card  from the cards list and saves it to latestCardPlayed
	 * variable. If zero cards are left it calls the reshuffling method. 
