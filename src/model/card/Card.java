...
/**
* Set card as played ,so it won't be able to be played again until the next reshuffling.
* @pre  The card is played.
* @post Set card as played after the move of the pawn ,so it won't be able to be played again.
*/
...
/**
* Moves the pawn accordingly to the card played. If the pawn moved to a square where 
* a pawn of different color is located, it sends the different color pawn to its 
