...
public class NumberOneCard extends NumberCard{
	...
	/** Constructor. 
	* Method to create an object of type NumberOneCard.
	* @pre 
	...
	*/
	...
	/**
* Pawn can start from the start square or move one square front. If the pawn moved to
*  a square where a pawn of different color is located, it sends the different color
* pawn to its start square. Also, if the pawn moved to a StartSlideSquare with 
* different color then it slides to the EndSlideSquare of this color and sends pawns
