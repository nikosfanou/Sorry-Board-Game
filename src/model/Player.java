...
public class Player {
	 ...
	 * @post Initialize the object of class player with the given name, color and
	 *       pawns.
	...
	/**
	 * Returns the color of the player which is the same color with the color of the
	 * pawns.
	 * 
	 ...
	 * @post Returns true if both of its pawns has reach the finish,else returns
	 *       false.
