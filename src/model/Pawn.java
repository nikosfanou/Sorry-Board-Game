...
public class Pawn {
	...
	/**
	 * When enabled is equal to false it means the pawn is located at its start or
	 * safety zone square. In other cases enabled is equal to true.
	 */
	private boolean enabled;
	/**
	 * When finished is equal to true it means the pawn is located at its home
	 * square, so it reached the finish and is not able to play/move any further.
	 */
	private boolean finished;

	/**
	 * Constructor. Method to create an object of type Pawn.
	 * 
	...
	/**
	 * Returns true if the pawn isn't located at its start,home or safety zone
	 * square,else returns false.
	 * 
	 * @pre
	 * @post Returns true if the pawn isn't located at its start,home or safety zone
	 *       square,else returns false.
	 * @return True if the pawn isn't located at its start,home or safety zone
	 *         square,else returns false.
	 */
	 ...
	 * 
	 * @pre
	 * @post Returns true if the pawn is located at its home square,else returns
	 *       false.
